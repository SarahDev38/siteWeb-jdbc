...
<tr>
	<td width=20% style="text-align:right"><label>Date :</label> </td>
	<td width=20% ><input type="text" readonly style="text-align:center; border:none;" value="<c:out value="${date}"/>" size="20" maxlength="20"/></td>
	<td></td>
</tr> 
<tr>
