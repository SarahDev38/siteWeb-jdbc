...
<script type="text/javascript" src='<c:url value="/inc/js/creerProduit.js" />' ></script>
<title>formulaire commande</title>
</head>
<body>
<c:import url="/inc/menu.jsp" />
<div class="content" style ="max-width:1000px;">
<form id = "formulaireProduit" name = "formulaireProduit" method="post" action="<c:url value="nouveauProduit" />" enctype="multipart/form-data">

	<fieldset style ="width:850px;">
		<legend>Type de produit</legend>
		<c:import url="/inc/formulaireRubrique.jsp" />
		<div id="divReference" hidden='hidden'>
	...
	<fieldset style ="width:850px;">
		...
		<div id="divProduit" hidden='hidden'>
			...
			<button class="bouton" id="reset" value="">Réinitialiser</button><br/><br/>
		</div>
